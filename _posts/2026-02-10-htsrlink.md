...
This result confirms our intuition: $\kappa(A)$ is indeed proportional to how fast the singular value spectrum of $A$ decays. In the following, we will use this result to connect HTSR with $\alpha$-REQ cleanly.
